$(document).ready(function(){
    ...
    if( window.location.href == baseUrl || window.location.href == baseUrl + "index.html" || window.location.href == baseUrl + "index.html#filmovi" || window.location.href == baseUrl + "index.html#autor2"){
    ...
    //--------------------  FILM -----------------------------
    for(let i=0; i<=30; i++){
        if(window.location.href == baseUrl + `film.html?id=${i}`){
            filtrirajFilm();
    ...
    //--------------------- WATCHLIST ---------------------------
    if(window.location.href == baseUrl + "watchlist.html"){
        $("#prazno").hide();
